import { AssertionMethodPurpose, AuthenticationPurpose, DIDDocument } from "@extrimian/did-core";
...
import { ModenaRequest } from "@extrimian/modena-sdk";

const modenaEndpoint = "https://demo.extrimian.com/sidetree-proxy";
let _kms: KMSClient
    ...
    new Promise<DIDDocument>((resolve, reject) => {
        setTimeout(async () => {
            const universalResolver = new DIDUniversalResolver({
                universalResolverURL: modenaEndpoint,
